  ...
  return (
    <div className="home-container">
      ...
      <div className="text-container">
        ...
        {/* Adding the welcome blurb here */}
        <p>Welcome to Music Kitty! 🎵🐱</p>
        <p>Discover a unique blend of music and feline affection here at Music Kitty. Our platform bridges the melodious world of music enthusiasts with the adorable realm of cat lovers. Whether you're an aspiring musician seeking inspiration from our furry friends, or a cat aficionado with a penchant for beats and rhythms, you've found your haven. Dive in to explore profiles, share your musical feline journey, and perhaps even adopt a melodious kitty. Join our community where every purr is a note and every note tells a tale!</p>
      </div>

      {/* Integrating the "coffee" design */}

            ...
            <div className="navbar-container" onClick={e => e.stopPropagation()}>
                ...
                {isOpen && (
                    <ul className="navbar-dropdown">
                        ...
                        <li className="navbar__item">
                            <Link className="navbar__link" to="/profiles" onClick={() => setIsOpen(false)}>Manage Profile</Link>
                        </li>
                        <li className="navbar__item">
                            <Link className="navbar__link" to="/profile-adoptions" onClick={() => setIsOpen(false)}>Adoptions</Link>
                        </li>
